...
<table class="table table-bordered">
	...
	<tr>
		<td colspan="2"><a
			href="/product/list?pageNum=${cri.pageNum }&amount=${cri.amount }&type=${cri.type }&keyword=${cri.keyword }"
			class="btn btn-outline-secondary">목록</a> <a
			href="/product/modify?pno=${pvo.pno }&pageNum=${cri.pageNum }&amount=${cri.amount }&type=${cri.type }&keyword=${cri.keyword }"
...
<form>
	<div class="input-group mb-3 input-group-lg">
		...
		<div class="input-group-append">
			<button class="btn btn-success" type="button" id="cmtSubmit">댓글 전송</button>
		</div>
	</div>
</form>
<ul class="list-group list-group-flush" id="cmtListULTag"></ul>
<ul class="pagination pagination-sm justify-content-center" id="cmtListPaging"></ul>
...
<script>
	$(function() {
		...
		listComment(pno,1);
		$(document).on("click", "#cmtSubmit", {pno:pno, writer:writer}, addComment);
	});
